...
namespace Diceforge.View
{
    public sealed class BoardLayoutTokenMover : MonoBehaviour
    {
        ...
        private bool _isExecutingStepSequence;
        ...
        {
            if (_isExecutingStepSequence || _moveRoutine != null)
                return;
            ...
            _moveRoutine = StartCoroutine(MoveStepsRoutine(steps));
        }
        ...
        private IEnumerator MoveStepsRoutine(int steps)
        {
            ...
            while (remaining > 0)
            {
                ...
                if (currentCellId == fromCellId)
                    break;

                remaining--;
            }

            _isExecutingStepSequence = false;
        }
    }
}
