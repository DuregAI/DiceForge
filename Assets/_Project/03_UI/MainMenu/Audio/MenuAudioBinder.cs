...
namespace Diceforge.UI.MainMenu
{
    public class MenuAudioBinder : MonoBehaviour
    {
        ...
        private void OnSfxSliderChanged(ChangeEvent<float> evt)
        {
            ...
            // SFX source будет на шаге 4 — тут пока только сохраняем
        }

        /// <summary>
        /// Можно дергать вручную, если в будущем UI пересоздается или ты открываешь настройки и хочешь синкнуть.
        /// </summary>
